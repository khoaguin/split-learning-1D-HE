...
def main():
    ...
    # construct the tenseal context to encrypt homomorphically
    # polynomial_modulus_degree = 16384
    # coeff_modulo_bit_sizes = [60, 39, 39, 39, 39, 39, 39, 39, 39, 60]
    # global_scale = pow(2, 39)
    polynomial_modulus_degree = 8192
    coeff_modulo_bit_sizes = [40, 21, 21, 21, 21, 21, 21, 40]
    global_scale = pow(2, 21)
    # polynomial_modulus_degree = 4096
    # coeff_modulo_bit_sizes = [40, 20, 20]
    # global_scale = pow(2, 21)
    # polynomial_modulus_degree = 2048
    # coeff_modulo_bit_sizes = [18, 18, 18]
    # global_scale = pow(2, 16)
    client.make_tenseal_context(polynomial_modulus_degree,
                                coeff_modulo_bit_sizes, 
                                global_scale)
    if hyperparams["verbose"]:
        print(f"Context: {polynomial_modulus_degree}, {coeff_modulo_bit_sizes}, {global_scale}")
